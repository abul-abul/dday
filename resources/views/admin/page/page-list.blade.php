...
@section('admin-content')
	...
	{!! HTML::style( asset('assets/admin/plugins/css/jquery-ui.css')) !!}
	{!! HTML::style( asset('assets/admin/plugins/css/datepicker.css')) !!}
	{!! HTML::style( asset('assets/admin/plugins/css/ui.jqgrid.css')) !!}
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					colModel:[
						...
						{width:70, editable: true,edittype:"checkbox",editoptions: {value:"Yes:No"},unformat: aceSwitch},
						{width:90, editable: true,edittype:"select",editoptions:{value:"FE:FedEx;IN:InTime;TN:TNT;AR:ARAMEX"}},
						{width:150, sortable:false,editable: true,edittype:"textarea", editoptions:{rows:"2",cols:"10"}} 
					], 
